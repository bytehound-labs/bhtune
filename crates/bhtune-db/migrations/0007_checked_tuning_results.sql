...
CREATE TEMP TABLE tune_results_classified AS
SELECT
    *,
    CASE
...
INSERT INTO tune_results_new (
    ...
    proportional, integral, derivative, invalid_reason
)
SELECT
    id, run_id, response_level, kp, ti_minutes, td_minutes,
    proportional, integral, derivative, legacy_invalid_reason
FROM tune_results_classified
WHERE legacy_invalid_reason IS NULL;
...
SELECT
    id, run_id, response_level, NULL, NULL, NULL,
    NULL, NULL, NULL, 'invalid', legacy_invalid_reason
FROM tune_results_classified
WHERE legacy_invalid_reason IS NOT NULL;

DROP TABLE tune_results_classified;
